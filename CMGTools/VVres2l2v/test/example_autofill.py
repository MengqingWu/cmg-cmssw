...
#        "inclusiveLeptons" : NTupleCollection("l",        leptonTypeExtra, 10, help="Inclusive Leptons"),
        ...
        "gentaus"         : NTupleCollection("GenTau", genParticleType, 6, help="Generated taus from decays W/Z/h decays"), #added by mengqing
...
print config #added by Mengqing
