...
# origin from /PhysicsTools/Heppy/python/analyzers/objects/autophobj.py
...
leptonType = NTupleObjectType("lepton", baseObjectTypes = [ particleType ], variables = [
    ...
    NTupleVariable("Tracker_HighPt_MuonId", lambda x : x.muonID("Tracker_HighPt") if abs(x.pdgId())==13 else 1, int, help="Muon Customized Tracker_HighPt id"), # added by mengqing
])
