...
class Muon( Lepton ):
    ...
    def muonID(self, name, vertex=None):
        if name == "" or name is None: 
            return True
        # The customized 'Tracker_HighPt' muon id was added by Mengqing
        # as described in AN-15-200
        # variables can be found from: https://twiki.cern.ch/twiki/bin/viewauth/CMS/SWGuideMuonIdRun2#HighPt_Muon
